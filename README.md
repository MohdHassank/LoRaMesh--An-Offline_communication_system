...
8) Can also share an images,pdf's,files by compressing it.
...
![alt](https://github.com/MohdHassank/LoRaMesh--An-Offline_communication_system/blob/main/images/App_UI.png?raw=true)
